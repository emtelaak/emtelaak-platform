      ...
      <div className="container py-12">
        <div className={`grid md:grid-cols-4 gap-8 ${isRTL ? 'text-right' : 'text-left'}`}>
          ...
          <div className="md:col-span-1">
            <Link href="/">
              <div className={`flex items-center gap-3 mb-4 cursor-pointer ${isRTL ? 'justify-end md:justify-start' : ''}`}>
        ...
        {/* Bottom Bar */}
        <div className={`border-t mt-8 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 ${isRTL ? 'md:flex-row-reverse' : ''}`}>
